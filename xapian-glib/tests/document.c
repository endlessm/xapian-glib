...
document_new_empty (void)
{
  ...
  g_assert_cmpint (xapian_document_values_count (empty), ==, 0);
...
document_remove_value (void)
{
  ...
  xapian_document_add_value (doc, 42, "hello world");
  g_assert_cmpint (xapian_document_values_count (doc), ==, 1);
  ...
  g_assert_cmpint (xapian_document_values_count (doc), ==, 0);
