...
#define XAPIAN_WRITABLE_DATABASE(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), XAPIAN_TYPE_DATABASE, XapianWritableDatabase))
#define XAPIAN_IS_WRITABLE_DATABASE(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), XAPIAN_TYPE_DATABASE))
#define XAPIAN_WRITABLE_DATABASE_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), XAPIAN_TYPE_DATABASE, XapianWritableDatabaseClass))
#define XAPIAN_IS_WRITABLE_DATABASE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), XAPIAN_TYPE_DATABASE))
#define XAPIAN_WRITABLE_DATABASE_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), XAPIAN_TYPE_DATABASE, XapianWritableDatabaseClass))
