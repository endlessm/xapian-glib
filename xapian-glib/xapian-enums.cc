...
XAPIAN_GLIB_DEFINE_FLAGS_TYPE (XapianDatabaseFlags, xapian_database_flags,
  XAPIAN_GLIB_DEFINE_ENUM_VALUE (XAPIAN_DB_NO_SYNC, "no-sync")
  XAPIAN_GLIB_DEFINE_ENUM_VALUE (XAPIAN_DB_FULL_SYNC, "full-sync")
  XAPIAN_GLIB_DEFINE_ENUM_VALUE (XAPIAN_DB_DANGEROUS, "dangerous")
  XAPIAN_GLIB_DEFINE_ENUM_VALUE (XAPIAN_DB_RETRY_LOCK, "retry-lock")
  XAPIAN_GLIB_DEFINE_ENUM_VALUE (XAPIAN_DB_BACKEND_GLASS, "backend-glass")
  XAPIAN_GLIB_DEFINE_ENUM_VALUE (XAPIAN_DB_BACKEND_CHERT, "backend-chert")
  XAPIAN_GLIB_DEFINE_ENUM_VALUE (XAPIAN_DB_BACKEND_STUB, "backend-stub"))
